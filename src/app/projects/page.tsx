        ...
        <div className="max-w-7xl mx-auto space-y-40">
          {projects.map((project, index) => (
            <div
              ...
              } gap-8 items-center group scroll-fade-in`}
            >
              {/* Project Images */}
              <div className="w-full md:w-3/5 relative group/image perspective">
                {/* Main Image */}
                <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 group-hover/image:scale-[1.02] group-hover/image:rotate-y-12">
                  <Image
                ...
                {/* Mobile Preview */}
                <div className={`absolute -bottom-6 ${index % 2 === 0 ? '-left-6' : '-right-6'} w-44 h-72 rounded-xl overflow-hidden border-[6px] border-white/90 dark:border-gray-800/90 shadow-2xl opacity-0 group-hover/image:opacity-100 transition-all duration-500 transform ${index % 2 === 0 ? '-translate-x-12 group-hover/image:translate-x-0' : 'translate-x-12 group-hover/image:translate-x-0'}`}>
                ...
                {/* Services Preview */}
                <div className={`absolute -top-8 ${index % 2 === 0 ? '-left-8' : '-right-8'} w-80 h-48 rounded-xl overflow-hidden border-[6px] border-white/90 dark:border-gray-800/90 shadow-2xl opacity-0 group-hover/image:opacity-100 transition-all duration-500 transform translate-y-12 group-hover/image:translate-y-0`}>
                  <div className="absolute inset-0 bg-white dark:bg-gray-800">
                    <Image
